...
const Header = ({ activeTab, userId, activeUrl, handleBreadcrumbClick }) => {
    ...
    <div className="sticky top-0 z-10 flex justify-between items-center min-h-[60px] px-8 py-1 bg-gradient-to-r from-gray-50 to-white shadow-sm border-b border-gray-200">
        ...
        {/* <div className="ml-6 flex items-center text-sm text-gray-500">
          {activeUrl.map((segment, index) => (
            ...
            >
              ...
              {index < activeUrl.length - 1 && <span>/</span>}
            </span>
          ))}
        </div> */}
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3 bg-white rounded-full pl-1 pr-4 py-1 border border-gray-200 hover:bg-gray-50 transition-colors cursor-pointer shadow-sm">
          ...
          <div>
            <div className="text-lm font-semibold text-gray-900">
              {username}
            </div>
