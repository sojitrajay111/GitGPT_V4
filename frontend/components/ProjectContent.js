        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">GitHub Repo</th>
              ...
              projects.map((project) => (
                <tr key={project._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-blue-600 hover:underline cursor-pointer max-w-xs truncate">
                    <a href={getGitHubRepo(project)} target="_blank" rel="noopener noreferrer">
      ...
      {showDialog && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
            ...
            {/* Loading Indicator */}
            {(createProjectLoading || githubAuthStatusLoading || githubReposLoading) && (
            ...
            {!githubAuthStatus && !githubAuthStatusLoading && (
              <div className="mb-4 p-3 bg-yellow-100 text-yellow-700 rounded-lg">
                ...
                but you won't be able to link to or create GitHub repositories directly.
              </div>
            )}
            ...
            {githubAuthStatus && (
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  ...
                  />
                  <label htmlFor="createNewRepo" className="ml-2 block text-sm font-medium text-gray-700">
                ...
                {createNewRepoOption ? (
                  <div>
                    <label htmlFor="newRepoName" className="block text-sm font-medium text-gray-700 mb-2">
                      New Repository Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="githubRepoSelect" className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <select
                      ...
                      disabled={githubReposLoading || !githubReposData?.repos || githubReposData.repos.length === 0}
                    >
                      <option value="">Select a repository</option>
                      {githubReposLoading ? (
                        <option disabled>Loading repositories...</option>
                      ) : githubReposData?.repos && githubReposData.repos.length > 0 ? (
            ...
            {!githubAuthStatus && (
              <div className="mb-4">
                <label htmlFor="githubRepoLink" className="block text-sm font-medium text-gray-700 mb-2">
