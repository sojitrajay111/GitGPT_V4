...
console.log("DEBUG: EMAIL_USER from .env:", process.env.EMAIL_USER); // TEMPORARY LOG
console.log("DEBUG: EMAIL_PASSWORD from .env:", process.env.EMAIL_PASSWORD); // TEMPORARY LOG - REMOVE AFTER DEBUGGING
